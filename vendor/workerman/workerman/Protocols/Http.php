...
class Http
{
    ...
    public static function encode($content, TcpConnection $connection)
    {
        ...
        // header
        $header .= "Server: AlexMVC based workerman"  . "\r\nContent-Length: " . strlen($content) . "\r\n\r\n";
    ...
    public static function sessionId($id = null)
    {
        ...
        if (static::sessionStarted() && HttpCache::$instance->sessionFile) {
            return str_replace('alex_', '', basename(HttpCache::$instance->sessionFile));
        }
        return '';
    }
    ...
    public static function sessionStart()
    {
        ...
        // Generate a SID.
        if (!isset($_COOKIE[HttpCache::$sessionName]) || !is_file(HttpCache::$sessionPath . '/alex_' . $_COOKIE[HttpCache::$sessionName])) {
            // Create a unique session_id and the associated file name.
            while (true) {
                $session_id = static::sessionCreateId();
                if (!is_file($file_name = HttpCache::$sessionPath . '/alex_' . $session_id)) break;
            }
        ...
        if (!HttpCache::$instance->sessionFile) {
            HttpCache::$instance->sessionFile = HttpCache::$sessionPath . '/alex_' . $_COOKIE[HttpCache::$sessionName];
        }
    ...
    public static function tryGcSessions()
    {
        ...
        $time_now = time();
        foreach(glob(HttpCache::$sessionPath.'/alex*') as $file) {
